...
@Composable
fun Privet(controller: NavController){
    val scaffoldState = rememberScaffoldState()
    Scaffold(backgroundColor = Color.Black,
            topBar = {
                TopAppBar(
                        title = {
                            Text("Privet File", style = TextStyle(fontSize = 20.sp, fontWeight = FontWeight.Bold))
                        },
                        navigationIcon = {
...
//                            Image(asset = imageResource(id = R.drawable.img),contentScale = ContentScale.Fit,)
                    ...
                    Card(modifier = Modifier.height(50.dp).fillMaxWidth(1f)) {
                        ListItem(text = { Text(text = "Movies") },
                                modifier = Modifier.clickable(onClick = {
                                    controller.navigate(R.id.action_privetFragment_to_movieMainFragment)
                                }))
                    }
                    Divider(color = Color.Blue)
                    Card(modifier = Modifier.height(50.dp).fillMaxWidth(1f)) {
                        ListItem(text = { Text(text = "Series") },
                                modifier = Modifier.clickable(onClick = {
                                    controller.navigate(R.id.action_privetFragment_to_seriesMainFragment)
                                }))
                    }
                    Divider(color = Color.Blue)
                    Card(modifier = Modifier.height(50.dp).fillMaxWidth(1f),
        ...
        ScrollableColumn() {
            ...
            Surface(color = Color.Transparent,modifier = Modifier.fillMaxWidth().height(50.dp)
                ...
                Text(text = "Privet",style = TextStyle(
                    ...
                    repeat(times = 2){
                        Card(
                            modifier = Modifier.height(200.dp).width(200.dp)
                                .clickable(onClick = {
                                    controller.navigate(R.id.action_privetFragment_to_playerFragment)
                                }).padding(2.dp)
                        ) {
                            Stack() {
//                                TODO IMAGE SET
//                                image
                                Column(modifier = Modifier.gravity(align = Alignment.BottomStart)) {
                                    ScrollableRow() {
                                        Text(text = "File Name",modifier = Modifier.padding(start = 5.dp),
                                                style = TextStyle(fontWeight = FontWeight.Bold,fontSize = 20.sp))
                                    }
                                    Text(text = "Duration Time",modifier = Modifier.padding(start = 5.dp))
                                }
                            }
